...
JMA_URL = "https://www.jma.go.jp/bosai/forecast/data/forecast/400000.json"  # 福岡県
AREA_CODE = "400040"  # 筑後地方（大牟田市）
...
def get_jma_weather():
    ...
    # JSON書き出し
    with open("omuta_tenki.json", "w", encoding="utf-8") as f:
        json.dump(result, f, ensure_ascii=False, indent=2)

    print("omuta_tenki.json を正常に生成しました:")
